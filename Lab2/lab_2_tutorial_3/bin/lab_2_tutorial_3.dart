...
void main() {
  ...
  */
  /*
        ...
        const name = ‘nirali ';
        message += name; // 'Hello my name is nirali'
 
        final message = StringBuffer();
        message.write('Hello');
        message.write(' my name is ');
        message.write('nirali');
        message.toString(); // "Hello my name is nirali"
  ...
  */
  /*
        ...
        const name = "nirali";
        const intro = "Hello , My name is $name"; //Hello my name is nirali
  ...
  */
  /*
        //Mini-Exercises
          ...
          //1.
          const firstname = "nirali ";
          const lastname = " darji ";
